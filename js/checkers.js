...
//}
//בעיות:
//להוסיף נצחון אחרי הקליק השני
//יש בעיה במצב שלוחצים על שחקן שלא יכול לצאת
...
//function IsLegalEat(firstClickElement, secondClickElement) {
//    var firstId = firstClickElement.id;
//    var secondId = secondClickElement.id;
//    var firstRow = Math.floor(firstId / 8);
//    var firstCol = firstId % 8;
...
//    if (damka[firstRow][firstCol] == 2 && damka[secondRow][secondCol] == 1 && (secondCol == firstCol + 2 || secondCol == firstCol - 2) && secondRow == firstRow + 2
//        ||
//        damka[firstRow][firstCol] == 3 && damka[secondRow][secondCol] == 1 && (secondCol == firstCol + 2 || secondCol == firstCol - 2) && secondRow == firstRow - 2) {

//        if (secondCol == firstCol + 2 &&  ) {
//        }
//    }
