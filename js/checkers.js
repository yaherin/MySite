...
var firstThis;
var images = ["img/light.jpg", "img/empty.jpg", "img/p1.jpg", "img/p2.jpg", "img/Queen1.jpg","img/Queen2.jpg"];
var damka =
    [
        [0, 2, 0, 2, 0, 2, 0, 2],
        [2, 0, 2, 0, 2, 0, 2, 0],
...
function Queen(secondClickElement) { //פונקציה שהופכת למלכה
...
function isLegalMoveQueen(firstClickElement, secondClickElement) { //ביצוע המהלך של המלכה אם אפשרי
...
function IsLegalMove(firstClickElement, secondClickElement) { //ביצוע המהלך של שחקן רגיל אם אפשרי
    var firstId = firstClickElement.id;
    var secondId = secondClickElement.id;
    var firstRow = Math.floor(firstId / 8);
    var firstCol = firstId % 8;
...
function IsTherePlaceToMoveQueen(firstClickElement) { //פונקציה שבודקת אם למלכה יש מקום לזוז אליו
    var firstId = firstClickElement.id;
    var firstRow = Math.floor(firstId / 8);
    var firstCol = firstId % 8;
...
function IsWin() { //בדיקת נצחון
    if (numofeatenpieces1 == 12) { //אם כל השחקנים של השחקן הראשון נאכלו נצחון לשחקן מספר 2
        document.getElementById("turns").innerHTML = p2name + " won!";
        document.getElementById("Start").outerHTML = "";
        AudioWin.play();
    }
    if (numofeatenpieces2 == 12) {//אם כל השחקנים של השחקן השני נאכלו נצחון לשחקן מספר 1
        document.getElementById("turns").innerHTML = p1name + " won!";
        document.getElementById("Start").outerHTML = "";
        AudioWin.play();
    }
    else {
        //בדיקה אם לאחד השחקנים אין אפשרות לזוז יותר בתורם
...
function isTherePlaceToMoveWin(i, k) { //פונקציה שבודקת אם יש בכלל מקום לעבור אליו ספציפית לנצחון
...
function IsTherePlaceToMoveWinQueen(i, k) {//פונקציה שבודקת אם יש בכלל מקום למלכה לעבור אליו ספציפית לנצחון
